...
void v0_shapes()
{
    ...
    //res6.print(std::cout);
    CU_ASSERT(numbers::core::equal(res6[0],3.0f,0.01f));
    CU_ASSERT(numbers::core::equal(res6[1],4.0f,0.01f));
...
void v0_matrix()
{
    ...
    numbers_here::matrix<int,2,3,float> mx19 = {1,2,3,4,5,6};
    //mx19.print(std::cout);
...
void v0_vector()
{
    ...
    */
    ...
    CU_ASSERT(numbers::core::equal(vect66.length(),15.36f))
    CU_ASSERT(numbers::core::equal(vect66.angle(),32.367f))
}
